...
type TransactionsQuery struct {
	...
	loadTotal  []func(context.Context, []*Transactions) error
...
func (tq *TransactionsQuery) Order(o ...OrderFunc) *TransactionsQuery {
...
func (tq *TransactionsQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
func (tq *TransactionsQuery) GroupBy(field string, fields ...string) *TransactionsGroupBy {
	grbuild := &TransactionsGroupBy{config: tq.config}
...
func (tq *TransactionsQuery) Select(fields ...string) *TransactionsSelect {
	...
	selbuild := &TransactionsSelect{TransactionsQuery: tq}
	selbuild.label = transactions.Label
...
func (tq *TransactionsQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (tgb *TransactionsGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (tgb *TransactionsGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (tgb *TransactionsGroupBy) sqlQuery() *sql.Selector {
...
func (ts *TransactionsSelect) Scan(ctx context.Context, v interface{}) error {
	if err := ts.prepareQuery(ctx); err != nil {
		return err
	}
	ts.sql = ts.TransactionsQuery.sqlQuery(ctx)
	return ts.sqlScan(ctx, v)
}

func (ts *TransactionsSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
