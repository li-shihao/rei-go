...
func (pu *PkgUpdate) SetTransactionID(s string) *PkgUpdate {
	pu.mutation.SetTransactionID(s)
	return pu
}

// SetObjectID sets the "ObjectID" field.
func (pu *PkgUpdate) SetObjectID(s string) *PkgUpdate {
	pu.mutation.SetObjectID(s)
	return pu
}

// SetBytecode sets the "Bytecode" field.
func (pu *PkgUpdate) SetBytecode(m map[string]interface{}) *PkgUpdate {
...
// SetTransactionID sets the "TransactionID" field.
func (puo *PkgUpdateOne) SetTransactionID(s string) *PkgUpdateOne {
	puo.mutation.SetTransactionID(s)
	return puo
}

// SetObjectID sets the "ObjectID" field.
func (puo *PkgUpdateOne) SetObjectID(s string) *PkgUpdateOne {
	puo.mutation.SetObjectID(s)
	return puo
}

// SetBytecode sets the "Bytecode" field.
func (puo *PkgUpdateOne) SetBytecode(m map[string]interface{}) *PkgUpdateOne {
