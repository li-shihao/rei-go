...
//
//	client.Pkg.Query().
//		GroupBy(pkg.FieldTransactionID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (pgb *PkgGroupBy) sqlScan(ctx context.Context, v any) error {
...
func (ps *PkgSelect) sqlScan(ctx context.Context, v any) error {
	rows := &sql.Rows{}
